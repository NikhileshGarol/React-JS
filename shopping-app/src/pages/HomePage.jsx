...
import { Container, Pagination, Typography, Grid, Box, Snackbar, CircularProgress } from "@mui/material";
...
const HomePage = () => {
  const { products, colors, materials, loading, filteredProductsData } = useProducts();
